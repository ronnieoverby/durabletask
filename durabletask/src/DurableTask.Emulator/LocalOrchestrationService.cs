...
namespace DurableTask.Emulator
{
    ...
    public class LocalOrchestrationService : IOrchestrationService, IOrchestrationServiceClient, IDisposable
    {
        ...
        static readonly JsonSerializerSettings StateJsonSettings = new()
        ...
        {
            if (creationMessage.Event is not ExecutionStartedEvent executionStartedEvent)
            {
